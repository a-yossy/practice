...
pub struct Args {
    ...
    #[arg(short('1'), action = clap::ArgAction::SetFalse, default_value = "true")]
    show_col1: bool,

    /// Suppress printing of column 2
    #[arg(short('2'), action = clap::ArgAction::SetFalse, default_value = "true")]
    show_col2: bool,

    /// Suppress printing of column 3
    #[arg(short('3'), action = clap::ArgAction::SetFalse, default_value = "true")]
    show_col3: bool,
